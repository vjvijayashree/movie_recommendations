# -*- coding: utf-8 -*-
"""
Created on Sat Jun 26 21:12:17 2021
...
#load the model and tdidf vectorizer from disk
...
def recommend():
    ...
    #convert strings to list (eg:"[1,2,3]" to [1,2,3])
    cast_ids=cast_ids.split(',')
    cast_ids=cast_ids[0].replace("[","")
    cast_ids=cast_ids[-1].replace("]","")

    #rendering the string to py string
    ...
    #passing all the data to html file
